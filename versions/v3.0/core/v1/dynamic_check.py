...
class DynamicCheckEngine:
    ...
    def step(self, step_content: str) -> Dict:
        ...
        # V2: Guaranteed trigger at step N if never triggered yet
        if self.current_step == 3 and self.mid_check_count == 0 and self.god_check_count == 0:
            result["trigger_mid"] = True
            result["reason"] = "第3步定期巡检 · 保底校验"
